...
namespace GLInternal {
    ...
    template<>
    void set_uniform<Mth::CVector<float,1>>(GLint location,
                                            Mth::CVector<float,1> const& v,
                                            bool transpose) {
        glUniform1fv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<float,2>>(GLint location,
                                      const Mth::CVector<float,2>& v,
                                      bool transpose) {
        glUniform2fv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<float,3>>(GLint location,
                                      const Mth::CVector<float,3>& v,
                                      bool transpose) {
        glUniform3fv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<float,4>>(GLint location,
                                      const Mth::CVector<float,4>& v,
                                      bool transpose) {
    ...
    template<>
    void set_uniform<Mth::CVector<int,1>>(GLint location,
                                    const Mth::CVector<int,1>& v,
                                    bool transpose) {
        glUniform1iv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<int,2>>(GLint location,
                                    const Mth::CVector<int,2>& v,
                                    bool transpose) {
        glUniform2iv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<int,3>>(GLint location,
                                    const Mth::CVector<int,3>& v,
                                    bool transpose) {
        glUniform3iv(location, 1, &v(0));
    }
    template<>
    void set_uniform<Mth::CVector<int,4>>(GLint location,
                                    const Mth::CVector<int,4>& v,
                                    bool transpose) {
        glUniform4iv(location, 1, &v(0));
    }
    
    template<>
    void set_uniform<Mth::Matrix<float,2,2>>(GLint location,
                                             Mth::Matrix<float,2,2> const& v,
                                             bool transpose) {
        glUniformMatrix2fv(location, 1, transpose ? GL_TRUE : GL_FALSE, &v(0,0));
    }
    template<>
    void set_uniform<Mth::Matrix<float,3,3>>(GLint location,
                                             Mth::Matrix<float,3,3> const& v,
                                             bool transpose) {
        glUniformMatrix3fv(location, 1, transpose ? GL_TRUE : GL_FALSE, &v(0,0));
    }
    template<>
    void set_uniform<Mth::Matrix<float,4,4>>(GLint location,
                                             Mth::Matrix<float,4,4> const& v,
                                             bool transpose) {
